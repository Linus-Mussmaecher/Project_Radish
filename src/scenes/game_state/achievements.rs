...
impl Achievement {
    ...
    pub fn info_element_small<T: Copy + Eq + std::hash::Hash + 'static>(
        ...
        if self.is_achieved() && self.icon.is_some() {
            ...
            graphics::Image::new(ctx, gfx_ctx, "./sprites/ui/lock.png").unwrap()
        }
    ...
    pub fn info_element_large<T: Copy + Eq + std::hash::Hash + 'static>(
        ...
        if let Ok(trophy) =
            graphics::Image::new(ctx, gfx_ctx, "./sprites/achievements/a00_16_16.png")
        {
    ...
    pub fn load(
        ...
        let mut list = vec![
            Achievement::new(
                "First Blood",
                "Kill an enemy.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a01_16_16.png").ok(),
                1,
            ...
            Achievement::new(
                "To Dust",
                "Kill 50 enemies.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a02_16_16.png").ok(),
                50,
                (GameMessage::EnemyKilled(0), GameMessageFilter::Type),
            ),
            Achievement::new(
                "They were legion",
                "Kill 1000 enemies.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a03_16_16.png").ok(),
                1000,
                (GameMessage::EnemyKilled(0), GameMessageFilter::Type),
            ),
            Achievement::new(
                ...
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a04_16_16.png").ok(),
                1000,
            ...
            Achievement::new(
                "Survivor",
                "Reach wave 2.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a05_16_16.png").ok(),
                1,
            ...
            Achievement::new(
                "Can't touch this",
                "Reach wave 5.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a06_16_16.png").ok(),
                1,
            ...
            Achievement::new(
                ...
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a07_16_16.png").ok(),
                8,
            ...
            Achievement::new(
                "Supreme",
                "Reach level 24.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a08_16_16.png").ok(),
                1,
            ...
            Achievement::new(
                "Royal Blood",
                "Kill an elite enemy.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a09_16_16.png").ok(),
                1,
            ...
            Achievement::new(
                ...
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a10_16_16.png").ok(),
                50,
                (GameMessage::EnemyKilled(10), GameMessageFilter::Min),
            ),
            Achievement::new(
                "Speed limit",
                "Kill 50 bannermen.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a11_16_16.png").ok(),
                50,
            ...
            Achievement::new(
                "Who you gonna call?",
                "Kill 15 ghosts.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a12_16_16.png").ok(),
                15,
            ...
            Achievement::new(
                ...
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a13_16_16.png").ok(),
                5,
            ...
            Achievement::new(
                ...
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a14_16_16.png").ok(),
                5,
            ...
            Achievement::new(
                ...
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a15_16_16.png").ok(),
                5,
            ...
            Achievement::new(
                "Oops",
                "Lose ten buildings.",
                graphics::Image::new(ctx, gfx_ctx, "/sprites/achievements/a16_16_16.png").ok(),
                10,
                ...
                if ach.listen(gm) {
                    gui.add_element(
                        ...
                        ui::containers::DurationBox::new(
                            ...
                            ach.info_element_large(ctx, gfx_ctx),
                        )
                        .to_element(0, ctx),
                    );
                }
